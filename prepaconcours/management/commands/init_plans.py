        ...
        plans_data = [
            {
                'code': 'test',
                'nom': 'Plan Test',
                'description': 'Essayez gratuitement pendant 24 heures avec accès limité',
                'prix': 0,
                'duree': '24h',
                'questions_par_jour': 100,
                'examens_blancs_par_mois': 0,
                'acces_ena': True,
                'acces_fonction_publique': False,
                'acces_tous_concours': False,
                'mode_classique': True,
                'mode_chronometre': False,
                'statistiques_basiques': False,
